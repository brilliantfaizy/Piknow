...
namespace Webservice.Models
{
    ...
    {
        public static void LogErrorToText(Exception ex, object abc = null)
        {
            ...
            while (innerEx != null)
            {
                ...
                sb.Append(Environment.NewLine);
                sb.Append(Environment.NewLine);
                sb.Append("Input Data : " + abc);
            }

            string path = "Webservice" + "_logs_" + DateTime.Now.ToString("yyyy-MM-dd") + ".log";
