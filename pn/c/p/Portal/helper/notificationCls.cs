    ...
    public class notificationCls
    {
        ...
        public void SendCrash_Report(string ex)
        {
            try
            {
                ...
                message.Subject = "Crash Report - Karenro Web Service " + String.Format("{0:f}", DateTime.Now);
        ...
        public void SendEmail_toUser(string toEmail, string subject, string heading, string mailBody)
        {
            try
            {
        ...
        public string myTime(DateTime yourDate)
        {
            ...
            var ts = new TimeSpan(yourDate.Ticks - easternTime.Ticks);
