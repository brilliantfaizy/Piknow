<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="vehiclePriceAdd.aspx.cs" Inherits="Portal.vehiclePriceAdd" %>
                            ...
                            <div class="form-horizontal form-label-left">
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-sm-9 col-xs-12 col-md-offset-5">
                                        <a href="vehiclePricing.aspx" class="btn btn-primary">Cancel</a>
                                        <asp:LinkButton ID="LinkButton1" runat="server" class="btn btn-success" OnClick="Add_Click">Add</asp:LinkButton>
                                    </div>
                                </div>
